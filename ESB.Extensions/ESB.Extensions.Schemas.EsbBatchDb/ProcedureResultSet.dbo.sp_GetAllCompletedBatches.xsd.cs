namespace ESB.Extensions.Schemas.EsbBatchDb {
    ...
    public sealed class ProcedureResultSet_dbo_sp_GetAllCompletedBatches : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:ns3=""http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/sp_GetAllCompletedBatches"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/sp_GetAllCompletedBatches"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      <fileNameHint xmlns=""http://schemas.microsoft.com/servicemodel/adapters/metadata/xsd"">ProcedureResultSet.dbo.sp_GetAllCompletedBatches</fileNameHint>
    </xs:appinfo>
  </xs:annotation>
  <xs:complexType name=""StoredProcedureResultSet0"">
    <xs:sequence>
      <xs:element minOccurs=""0"" maxOccurs=""1"" name=""BatchId"" nillable=""true"" type=""xs:string"" />
      <xs:element minOccurs=""0"" maxOccurs=""1"" name=""SequenceId"" nillable=""true"" type=""xs:string"" />
    </xs:sequence>
  </xs:complexType>
  ...
  <xs:element name=""ArrayOfStoredProcedureResultSet0"" nillable=""true"" type=""ns3:ArrayOfStoredProcedureResultSet0"" />
        ...
        public ProcedureResultSet_dbo_sp_GetAllCompletedBatches() {
        }
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/sp_GetAllCompletedBatches",@"StoredProcedureResultSet0")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/sp_GetAllCompletedBatches",@"ArrayOfStoredProcedureResultSet0")]
        [System.SerializableAttribute()]
